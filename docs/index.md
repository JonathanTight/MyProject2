# **Мобильное приложение для доставки еды из сети ресторанов.** ARIG ПРОВЕРКА 
ПРОВЕРКА УСПЕШНАЯ 11-57dfdf
...
**Участники:**  
  ...
  - **Пользователь (клиент):**  
     использует мобильное приложение для оформления заказов, отслеживания доставки, редактирования профиля.  
  - **Мобильное приложение:**  
     клиентская часть, где пользователь взаимодействует с системой.  
  - **Серверное приложение:**  
     отвечает за логику обработки заказов, управления пользователями и взаимодействия с базой данных.  
  - **База данных:**  
     хранит информацию о заказах, пользователях, меню и транзакциях.  
  - **Внешние API (платежные системы, уведомления):**  
     интеграция с внешними сервисами для обработки платежей, отправки уведомлений и т.д.

![alt text](<с1 - visual selectioneqweq.svg>)
<br>
<br>
**2. Диаграмма контейнеров (Level 2)**
   ...
   **Контейнеры:**  
   ...
   - **Мобильное приложение (клиент):**  
     нативное мобильное приложение для пользователей, которое позволяет:  
...
![alt text](<c121visual selection 2ewrr.svg>)
<br>
<br>
<br>

   - **Серверное приложение:**  
     бэкенд для обработки логики:  
     - Получение запросов от клиентов  
     - Обработка заказов  
     - Взаимодействие с базой данных и внешними сервисами  

![alt text](<c122- visual selectiondfw.svg>)  
...
![alt text](dfsfsf.svg)
   ...
   - **Внешние API:**  
     интеграции с внешними сервисами для:  
     - Платежей (например, через платёжный шлюз)  
     - Уведомлений (push-сообщения, email-уведомления)
     - Синхронизации (CRM Мой Склад)

![alt text](<c42112visual selection.svg>)
<br>
<br>
<br>
<br>
...
**4. Диаграмма взаимодействий (Level 4)**
   ...
   **Пример сценария:**  
   ...
   2. Пользователь выбирает товар из меню и добавляет его в корзину.  
   3. Пользователь оформляет заказ и выбирает способ доставки.  
   4. Серверное приложение обрабатывает запрос, взаимодействует с базой данных для создания нового заказа.  
   5. Внешняя система уведомлений отправляет уведомление пользователю о статусе заказа.  
   6. Платежная система обрабатывает оплату.  
   7. База данных обновляет транзакцию и статус заказа.
...
??? info "SRS (Software Requirements Specification)"  
    ...
    <h2>1.3. Участники системы (Actors)</h2>
    ...
    <h2>1.4. Ограничения и допущения</h2>
    ...
    <h2>1.5. Архитектурный контекст (высокоуровнево)</h2>
    ...
    <h4>10. Редактирование профиля</h4>  
    ...
    <h4>11. Управление заказами (админ)</h4>  
    ...
    <h4>12. Уведомления для персонала</h4>  
    ...
    <h4>13. Минималистичный дизайн</h4>  
    ...
    <h4>14. Проверка зоны доставки</h4>  
    ...
    <h2>3. Ошибочные сценарии (Edge Cases)</h2>
    ...
    <h2>4. Требования к безопасности</h2>
    ...
    <h2>5. Критерии приёмки в целом</h2>
    ...
    <h4>CRM-интеграция (в фоне, async)</h4>
